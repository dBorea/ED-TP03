...
char *gpacesso[] = {
    "set term pngcairo enhanced font 'Times New Roman, 32.0' size 1500,1100",
    "set output \"%s-acesso-%d.%s\"",
    "set title \"Grafico de acesso - ID %d\"",
    "set xlabel \"Acesso\"",
    "set ylabel \"Endereco\"",
    "plot \"%s-acesso-0-%d.gpdat\" u 2:4 w points pt 13 ps 2 t \"L\", \"%s-acesso-1-%d.gpdat\" u 2:4 w points pt 13 ps 2 t \"E\"",
    0};
